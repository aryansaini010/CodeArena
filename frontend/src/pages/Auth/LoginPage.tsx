    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg-primary)] px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg-card)] p-8 shadow-2xl">
          <h2 className="mb-1 text-2xl font-bold text-[var(--text-primary)]">Welcome back</h2>
          <p className="mb-6 text-sm text-[var(--text-muted)]">Sign in to continue your coding journey</p>
          ...
          <div className="mt-6 text-center text-sm text-[var(--text-muted)]">
            ...
            <Link to="/register" className="font-medium text-[var(--gradient-start)] hover:underline">
              Sign up
            </Link>
          </div>
        </div>
